...
Source: {#DependDir}\bin\osg44-osg.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg44-osgDB.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg44-osgGA.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg44-osgSim.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg44-osgText.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg44-osgUtil.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg44-osgViewer.dll; DestDir: {app}\bin
...
Source: {#DependDir}\bin\osgplugins-2.6.0\osgdb_png.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osgplugins-2.6.0\osgdb_obj.dll; DestDir: {app}\bin
