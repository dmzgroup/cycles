...
Source: {#DependDir}\bin\osg65-osg.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgDB.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgFX.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgGA.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgSim.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgText.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgTerrain.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgUtil.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg65-osgViewer.dll; DestDir: {app}\bin
...
Source: {#DependDir}\bin\osgplugins-2.8.3\osgdb_png.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osgplugins-2.8.3\osgdb_obj.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osgplugins-2.8.3\osgdb_ive.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osgplugins-2.8.3\osgdb_osgfx.dll; DestDir: {app}\bin
