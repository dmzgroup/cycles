...
Source: {#DependDir}\bin\osg48-osg.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg48-osgDB.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg48-osgGA.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg48-osgSim.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg48-osgText.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg48-osgUtil.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osg48-osgViewer.dll; DestDir: {app}\bin
...
Source: {#DependDir}\bin\osgplugins-2.6.1\osgdb_png.dll; DestDir: {app}\bin
Source: {#DependDir}\bin\osgplugins-2.6.1\osgdb_obj.dll; DestDir: {app}\bin
